...
/* UPDATED: Style for the hazard source cell, now applies to instruction label too */
.hazard-source-highlight {{
    border: 3px solid #FF4500; /* OrangeRed border for better visibility */
    box-shadow: 0 0 10px rgba(255, 69, 0, 0.7); /* OrangeRed shadow */
}}
</style>
</head>
<body>
...
<div class="legend">
    <div class="legend-item"><div class="legend-color-box"></div><span>Forwarding Detected</span></div>
    <div class="legend-item"><div class="legend-color-box hazard-source-highlight" style="background-color: #FFFACD !important;"></div><span>Hazard Source</span></div>
</div>
        ...
        instructionLabels.forEach((label, instrIdx) => {{
            ...
            ["IF", "ID", "EX", "MEM", "WB"].forEach(stageName => {{
                ...
                if (instrCycleData && instrCycleData.stage === stageName) {{
                    ...
                    // This is the existing check that highlights the stage cell (e.g., MEM or WB)
