...
print("\n--- Summary of PC(hex), Actual PC(bin), Hex, and Disassembled Instruction ---")
...
for actual_pc, synthetic_pc in sorted_pcs_for_print:
    ...
    print(f" PC(hex): 0x{synthetic_pc:08x} | Actual PC: 0x{actual_pc:08x} | Hex: {instr_hex_display} | ASM: {disassembled}")
print("-----------------------------------------------------------------------------------\n")
